...
- Boczna poduszka powietrzna kierowcy
- 
- Boczne poduszki powietrzne - przód`,wersja:"1.4 16V Cosmo",slogan1:"Potwierdzony przebieg: 182842 km, certyfikat N.A.P",slogan2:"Bogata wersja wyposażenia COSMO",status_sprzedany:"NIE"," LINK_LINK-PUSTE-AUTO":"",opis:"",opis_ig:"",opis_fb:""}];function Tc(){const e=Ec;return ae.jsxs("div",{className:"app-container",children:[ae.jsx("header",{className:"header",children:ae.jsx("h1",{children:"Nasza Oferta Aut"})}),ae.jsx("div",{className:"cars-grid",children:e.map((n,t)=>{const i=n.link_glowne?n.link_glowne.split(",")[0].trim():"https://via.placeholder.com/400x250",a=`${n.Marka||""} ${n.Model||""}`.trim()||"Pojazd",o=n.Cena?isNaN(n.Cena.toString().replace(/\s/g,""))?n.Cena:parseInt(n.Cena.toString().replace(/\s/g,"")).toLocaleString()+" PLN":"Cena tel.",r=n.Opis||"";return ae.jsxs("div",{className:"auto-card",children:[ae.jsxs("div",{className:"card-image",children:[ae.jsx("img",{src:i,alt:a,onError:u=>u.target.src="https://via.placeholder.com/400x250"}),ae.jsx("span",{className:"status-badge",children:n.Status||"Dostępny"})]}),ae.jsxs("div",{className:"card-content",children:[ae.jsx("h3",{children:a}),ae.jsx("p",{className:"price",children:o}),r&&ae.jsx("p",{className:"description-text",children:r}),ae.jsx("button",{className:"details-btn",children:"Szczegóły"})]})]},t)})})]})}Ua.createRoot(document.getElementById("root")).render(ae.jsx(gp.StrictMode,{children:ae.jsx(Tc,{})}));
